...
var server = createServer(function (req, res) {
    if (req.method === "GET" || req.method === "HEAD") {
        ...
        var handler = routes[parsedUrl.pathname] || notFound;

        req.data = parsedUrl.query;
        ...
        sys.puts("HTTP " + req.method+ " requests are not yet supported.");
    }
});

fu.route = function (path, handler) {
    routes[path] = handler;
};
